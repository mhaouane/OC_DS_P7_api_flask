...
@app.route('/make_explication/<id>')
def make_explication(id) : 
    # show the data explixcation id
    return f' make_explication {(id)} '

@app.route('/get_statistics/<id>')
def get_statics(id) : 
    # show the statistics data id
    return f' Bonjour get_statistics {(id)} '
